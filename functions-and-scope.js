...
function averageGrade2Dec(numbersArray){
...
console.log(averageGrade2Dec(grades));
console.log(averageGrade2Dec([6, 4, 5]));
console.log(averageGrade2Dec([8, 9, 4, 6, 10]));
